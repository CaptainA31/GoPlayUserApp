...
const AlertBox = ({ alertBox, setAlertBox, cancel, success, message, title, onSuccess, onAbort }) => {
            ...
            success ?
              <View style={{ flexDirection: "row", borderTopWidth: 0.8, borderColor: colors.shade, justifyContent: "space-between", paddingVertical: "4%" }}>
                <View style={{ width: "50%", alignItems: "center" }}>
                  <Text style={{ color: '#40baff', fontSize: RFValue(14), fontWeight: "bold" }}>Cancel</Text>
                </View>
                <View style={{ width: "50%", alignItems: "center" }}>
              ...
              <View style={{ flexDirection: "row", borderTopWidth: 0.8, borderColor: colors.shade, justifyContent: "space-between", paddingVertical: "4%" }}>
                <TouchableOpacity
                  ...
                  <Text style={{ fontSize: RFValue(14), fontWeight: "bold" }}>Ok</Text>
                </TouchableOpacity>
